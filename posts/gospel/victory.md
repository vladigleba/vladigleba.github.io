...
{% ct '1 Corinthians 10:13' %}

We saw in {% rf 'James 1:12' false %} that God does not tempt anyone, but now we have a promise that He will not allow us to be tested beyond what we are able to bear! He provides a way of escape for every temptation the devil throws at us!

## What if I’ve struggled with the same sin for years?

> For the weapons of our warfare are not carnal, but *mighty through God to the pulling down of strong holds*.
{% ct '2 Corinthians 10:4' %}
